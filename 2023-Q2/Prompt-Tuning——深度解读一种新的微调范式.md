...
{#t3}面向预训练语言模型的Prompt-Tuning技术发展历程：
-----------------------------------
...
![在这里插入图片描述](https://image.cubox.pro/article/2023022110174674285/70763.jpg)  
...
![](https://image.cubox.pro/article/2023022110174659657/79580.jpg)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023022110174692262/21005.jpg)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445563693/49059.jpg?imageMogr2/quality/90/ignore-error/1)
>   按照ICL的模式，拼接若干个样本。对于每个样本添加模板，例如Input、Output。红色部分则为Label。

  按照这一模式，定义不同的预训练任务：  
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445526993/34859.jpg?imageMogr2/quality/90/ignore-error/1)  
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445561771/51904.jpg?imageMogr2/quality/90/ignore-error/1)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445631808/11651.jpg?imageMogr2/quality/90/ignore-error/1)
...
  如下图，给定一个情感分析task：
![](https://image.cubox.pro/article/2023040610445561609/40928.jpg?imageMogr2/quality/90/ignore-error/1)
...
  方法很简单，如下所示：  
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445527607/76846.jpg?imageMogr2/quality/90/ignore-error/1)  与GPT-3一样，在训练时，模型的输入包含当前task的 K K K 个样本，以及第 K + 1 K+1 K+1 个样本输入，使用交叉熵更新模型。在测试阶段，给定unseen target task，无需再次更新模型，只需要将对应的 K K K 个样本拼接输入模型即可对其他样本预测。
...
![](https://image.cubox.pro/article/2023040610445566411/37761.jpg?imageMogr2/quality/90/ignore-error/1)
...
![](https://image.cubox.pro/article/2023040610445628371/38097.jpg?imageMogr2/quality/90/ignore-error/1)

### {#t18}5.2 Instruction-tuning（指令学习）

  面向超大规模模型第二个Prompt技术是指令学习。在上文我们介绍过，Prompt的本质之一是任务的一种指令，因此，在对大规模模型进行微调时，可以为各种类型的任务定义指令，并进行训练，来提高模型对不同任务的泛化能力。

  什么是指令呢？如下图所示：
![](https://image.cubox.pro/article/2023040610445650651/92461.jpg?imageMogr2/quality/90/ignore-error/1)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445599824/26743.jpg?imageMogr2/quality/90/ignore-error/1)  
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445646949/14518.jpg?imageMogr2/quality/90/ignore-error/1)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445614333/40501.jpg?imageMogr2/quality/90/ignore-error/1)  
  另一种微调策略则是引入互联网搜索机制，提高模型生成结果的事实性：  
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445561829/95344.jpg?imageMogr2/quality/90/ignore-error/1)  
  最近与ChatGPT类似的Bard大模型则是基于LaMDA微调的模型。

#### InstructionGPT

  另外一个典型的例子是OpenAI的InstructionGPT，其主要流程如下：  
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445529572/94365.jpg?imageMogr2/quality/90/ignore-error/1)
...
> 训练目标如下：  
> ![在这里插入图片描述](https://image.cubox.pro/article/2023040610445587660/97913.jpg?imageMogr2/quality/90/ignore-error/1)  
...
![](https://image.cubox.pro/article/2023040610445688743/47786.jpg?imageMogr2/quality/90/ignore-error/1)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445644763/43812.jpg?imageMogr2/quality/90/ignore-error/1)  
  作者也探索了一些其他的投票策略，例如根据logit进行加权等，发现直接投票更合适：  
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445671217/18962.jpg?imageMogr2/quality/90/ignore-error/1)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445567955/36452.jpg?imageMogr2/quality/90/ignore-error/1)  
  主要包括两个核心步骤：
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445634058/43857.jpg?imageMogr2/quality/90/ignore-error/1)  
  主要包括两个步骤：  
**（1）Queston Clustering：**   
  使用sentence-BERT对每个question获得表征，然后通过K-means获得若干簇。对于每个簇，按照其距离簇中心距离的大小升序排列。算法如下所示：
![](https://image.cubox.pro/article/2023040610445672401/38592.jpg?imageMogr2/quality/90/ignore-error/1)
...
![](https://image.cubox.pro/article/2023040610445564086/97974.jpg?imageMogr2/quality/90/ignore-error/1)
...
![在这里插入图片描述](https://image.cubox.pro/article/2023040610445514853/58927.jpg?imageMogr2/quality/90/ignore-error/1)
...
### {#t23}6.3 Prompt-Tuning在ChatGPT里的应用
...
[跳转到 Cubox 查看](https://cubox.pro/my/card?id=7043482316382930631)
